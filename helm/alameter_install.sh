...
$default_path install --name alameda --namespace alameda $alameter_pwd/alameda --set image.repository=quay.io/prophetstor/alameda-operator-rhel --set image.tag=v0.3.16 --set image.pullPolicy=Always --set evictioner.image.repository=quay.io/prophetstor/alameda-evictioner-rhel --set evictioner.image.tag=v0.3.16 --set image.pullPolicy=Always --set admission-controller.image.repository=quay.io/prophetstor/alameda-admission-rhel --set admission-controller.image.tag=v0.3.16 --set image.pullPolicy=Always --set datahub.image.repository=quay.io/prophetstor/alameda-datahub-rhel --set datahub.image.tag=v0.3.16 --set datahub.image.pullPolicy=Always --set alameda-ai.image.repository=quay.io/prophetstor/alameda-ai --set alameda-ai.image.tag=v0.3.16 --set alameda-ai.image.pullPolicy=Always
